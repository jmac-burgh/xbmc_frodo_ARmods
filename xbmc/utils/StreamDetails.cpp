 ...
 *
 *
 *  File modified to include more of the common Aspect Ratios of movies.  Modifications begin
 *  at line 505				03/23/2013	jmac
 *
 */
...
CStdString CStreamDetails::VideoAspectToAspectDescription(float fAspect)
{
  ...
  if (fAspect < 1.3499f) // sqrt(1.33*1.37)
    ...
    return "2.35";
  else if (fAspect < 2.5737f) // sqrt(2.40*2.76)
    return "2.40";
  return "2.76";
}
